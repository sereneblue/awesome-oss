...
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.audacityteam.org/community/) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.audacityteam.org/)
...
- [Free Software Foundation](http://www.fsf.org/) - non-profit organization to support the free software movement
...
- [Rupy Central](http://www.rubycentral.org/) - non-profit organization dedicated to support and advocacy for the Ruby programming language
...
- [VideoLAN](http://www.videolan.org/videolan/) - non-profit organization that develops and promotes open-source multimedia solutions
[![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.videolan.org/contribute.html#money)
...
- [Cyberduck](https://cyberduck.io) - open source client for FTP and SFTP, WebDAV, and cloud storage
...
- [WinSCP](https://winscp.net/eng/index.php) - free and open-source SFTP, FTP, WebDAV and SCP client for Microsoft Windows
...
- [Blender](https://blender.org/) - Free and Open 3D Creation Software
...
- [Caesium Image Compressor](https://saerasoft.com/caesium/) - free, open source, advanced compression tool for photos and images (JPG, PNG, GIF)
...
- [GIMP](https://www.gimp.org/) - free and open-source raster graphics editor used for image retouching and editing, free-form drawing, converting between different image formats, and more specialized tasks
...
- [ImageMagick](https://imagemagick.org/) - free and open-source software suite for displaying, converting, and editing raster image and vector image files
...
- [Krita](https://krita.org/) - free and open-source raster graphics editor designed primarily for digital painting and animation purpose
...
- [LibreCAD](http://librecad.org/) - free Computer-aided design application for 2D design
...
- [Pinta](https://pinta-project.com/pintaproject/pinta/) - free, open source program for drawing and image editing
...
- [Kodi](https://kodi.tv) - free and open-source media player software application
...
- [Media Player Classic](https://mpc-hc.org) - light-weight, open source media player for Windows
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://trac.mpc-hc.org/wiki/opencall)
- [MPlayer](http://mplayerhq.hu/) - free and open media player software
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://mplayerhq.hu/design7/mailing_lists.html) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://mplayerhq.hu/design7/donations.html)
...
- [VLC](http://www.videolan.org/) - free and open source cross-platform multimedia player and framework
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.videolan.org/contribute.html) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.videolan.org/contribute.html)

### Networking

- [Apache](https://httpd.apache.org/) - free and open-source cross-platform web server software
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://wiki.apache.org/httpd/Contributing) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.apache.org/foundation/contributing.html)
- [Nginx](http://nginx.org/) - A HTTP and mail proxy server
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://nginx.org/en/docs/contributing_changes.html) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://nginx.org/en/donation.html)
- [Nmap](https://nmap.org/) - Free Security Scanner, Port Scanner, & Network Exploration Tool
...
- [OpenWRT](https://www.openwrt.org/) - open source project for embedded operating system based on Linux, primarily used on embedded devices to route network traffic
...
- [ownCloud](https://owncloud.org/) - open source, self-hosted file sync and share app platform
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://owncloud.org/contribute/)
- [Remmina](http://www.remmina.org/) - feature rich Remote Desktop Application
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.remmina.org/wp/contributing-to-remmina/) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.remmina.org/wp/donations/)
- [Syncthing](https://syncthing.net/) - free, open-source peer-to-peer file synchronization
...
- [Android-X86](https://www.android-x86.org/) - an unofficial initiative to port Google's Android mobile operating system to run on devices powered by AMD and Intel x86 processors
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.android-x86.org/donate) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](https://www.android-x86.org/donate)
...
- [Kubuntu](http://www.kubuntu.org/) - an official flavour of the Ubuntu operating system which uses the KDE Plasma Desktop
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.kubuntu.org/contribute-to-kubuntu/) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.kubuntu.org/donate)
...
- [OpenBSD](www.openbsd.org) - free and open source Unix-like computer operating system descended from Berkeley Software Distribution
...
- [Ubuntu Linux](http://www.ubuntu.com/) - a Linux distribution based on the Debian architecture
...
- [MediaWiki](https://www.mediawiki.org/wiki/MediaWiki) - free and open-source wiki software
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://www.mediawiki.org/wiki/Special:MyLanguage/How_to_contribute) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](https://wikimediafoundation.org/wiki/Ways_to_Give#bitcoin)
- [OpenSSL](https://www.openssl.org/) - open source project that provides a robust, commercial-grade, and full-featured toolkit for TLS & SSL
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://www.openssl.org/community/)
- [Stockfish Chess](https://stockfishchess.org/) - free and open source UCI chess engine
...
- [Password Safe](https://pwsafe.org/) - free and open-source password manager
...
- [Code::Blocks](http://www.codeblocks.org/) - free, open-source cross-platform IDE that supports multiple compilers including GCC, Clang and Visual C++
...
- [Lime Text](http://limetext.org/) - open source API-compatible alternative to the text editor Sublime Text
...
- [Avidemux](http://fixounet.free.fr/avidemux/) - a free and open-source video editing program designed for video editing and video processing
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://github.com/mean00/avidemux2)
- [HandBrake](https://handbrake.fr/) - an open-source, GPL-licensed, multiplatform, multithreaded video transcoder
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://github.com/HandBrake/HandBrake)
- [KdenLive](https://kdenlive.org/) - a free and open-source video editing software based on the MLT Framework, KDE and Qt
...
- [Open Broadcaster Software](https://obsproject.com/) - a free and open source streaming and recording program maintained by the OBS Project
...
- [OpenShot Video Editor](http://www.openshot.org/) - a free and open-source video editor for FreeBSD, Linux, macOS, and Windows
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://github.com/OpenShot/openshot-qt) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.openshot.org/donate/)
...
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](http://www.chromium.org/developers/contributing-code)
...
- [NetSurf](http://www.netsurf-browser.org) - an open source web browser which uses its own layout engine
...
- [PaleMoon](http://www.palemoon.org/) - an open-source web browser with an emphasis on customizability
[![Contribute](https://cdn.rawgit.com/sereneblue/awesome-oss/master/contribute.svg)](https://www.palemoon.org/donations.shtml#Donating_services) [![Donate](https://cdn.rawgit.com/sereneblue/awesome-oss/master/donate.svg)](http://www.palemoon.org/donations.shtml)
...
- [SeaMonkey](https://www.seamonkey-project.org/) - free and open-source Internet suite
...
- [TorBrowser](https://www.torproject.org/projects/torbrowser.html) - a version of Mozilla Firefox that has been modified by the Tor Project for enhanced security and privacy
